...
from autoai_ts_libs.srom.estimators.time_series.models.srom_estimators import (  # type: ignore # noqa
    FlattenAutoEnsembler as model_to_be_wrapped,
)
...
class _FlattenAutoEnsemblerImpl:
    def __init__(
        self,
        feature_columns,
        target_columns,
    ...
    "allOf": [
        {
            ...
            "properties": {
                ...
                "init_time_optimization": {
                    "description": "Boolean indicating if optimization should occur only at the start of automation.",
                    "type": "boolean",
                    "default": False,
                },
                "data_transformation_scheme": {
                    "description": "Data transformation to be applied to input and output of the estimator.",
                    "enum": [
                        "auto",
                        "log",
                        "mean_division",
                ...
                "total_execution_time": {
                    "description": "Approximate maximum runtime allowed.",
                    "type": "integer",
                    "default": 2,
                },
                "execution_time_per_pipeline": {
                    "description": "Maximum execution time per pipeline.",
                    "type": "number",
                    "default": 1,
                },
                "dag_granularity": {
                ...
                "execution_platform": {
                    "description": "Platform for execution of srom pipeline.",
                    "enum": [
                ...
                "n_leaders_for_ensemble": {
                    "description": "Number of models to use when creating the ensemble model.",
                    "type": "integer",
                    "default": 5,
                },
                "n_estimators_for_pred_interval": {
                    "description": "Number of estimators to used to estimate prediction intervals.",
                    "type": "integer",
                    "default": 30,
                },
                "max_samples_for_pred_interval": {
                    "description": "Maximum number of samples to use when generating prediction intervals.",
                    "type": "number",
                    "default": 1.0,
                },
                "multistep_prediction_strategy": {
                    "description": "Strategy to apply for multistep predictions.",
                ...
                "ensemble_type": {
                    "description": "Ensemble method used to combine predictors.",
                    "enum": ["voting", "stacked"],
                    "default": "voting",
                },
                "store_lookback_history": {
...
.. _`autoai_ts_libs`: https://pypi.org/project/autoai-ts-libs""",
    "documentation_url": "https://lale.readthedocs.io/en/latest/modules/autoai_ts_libs.lale.flatten_auto_ensembler.html",
...
FlattenAutoEnsembler = lale.operators.make_operator(
    _FlattenAutoEnsemblerImpl, _combined_schemas
)

lale.docstrings.set_docstrings(FlattenAutoEnsembler)
