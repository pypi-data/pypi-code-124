...
e.g., in case of fill interpolator it is filled with default_value.""",
                ...
                "imputer_fill_value": {
                    ...
                    "anyOf": [
                        ...
                        {
                            "type": "integer"
                        },  # number is a super-type of integer, but explicitly listing this to match code.
                        {"enum": [None]},
                    ],
                    "default": 0.0,
                },
...
.. _`autoai_ts_libs`: https://pypi.org/project/autoai-ts-libs""",
    "documentation_url": "https://lale.readthedocs.io/en/latest/modules/autoai_ts_libs.lale.fill.html",
...
fill = lale.operators.make_operator(model_to_be_wrapped, _combined_schemas)

lale.docstrings.set_docstrings(fill)
