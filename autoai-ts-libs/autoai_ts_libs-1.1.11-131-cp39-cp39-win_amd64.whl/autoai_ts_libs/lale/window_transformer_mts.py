...
from autoai_ts_libs.sklearn.small_data_standard_row_mean_center_transformers import (  # type: ignore # noqa
    WindowTransformerMTS as model_to_be_wrapped,
)
...
class _WindowTransformerMTSImpl:
...
.. _`autoai_ts_libs`: https://pypi.org/project/autoai-ts-libs""",
    "documentation_url": "https://lale.readthedocs.io/en/latest/modules/autoai_ts_libs.lale.window_transformer_mts.html",
...
WindowTransformerMTS = lale.operators.make_operator(
    _WindowTransformerMTSImpl, _combined_schemas
)
lale.docstrings.set_docstrings(WindowTransformerMTS)
