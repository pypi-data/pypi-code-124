...
from autoai_ts_libs.srom.estimators.time_series.models.srom_estimators import (  # type: ignore # noqa
    LocalizedFlattenAutoEnsembler as model_to_be_wrapped,
)
...
class _LocalizedFlattenAutoEnsemblerImpl:
    def __init__(
        self,
        feature_columns,
        target_columns,
...
.. _`autoai_ts_libs`: https://pypi.org/project/autoai-ts-libs""",
    "documentation_url": "https://lale.readthedocs.io/en/latest/modules/autoai_ts_libs.lale.localized_flatten_auto_ensembler.html",
...
LocalizedFlattenAutoEnsembler = lale.operators.make_operator(
    _LocalizedFlattenAutoEnsemblerImpl, _combined_schemas
)

lale.docstrings.set_docstrings(LocalizedFlattenAutoEnsembler)
